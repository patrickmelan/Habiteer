    ...
    return (
      <div className="flex justify-center flex-col">
          <div className="flex flex-col h-screen w-full items-center ">
            ...
            <span className="text-6xl text-white">Welcome to <span className="bg-gradient-to-r from-green-200 via-indigo-300 to-purple-400 inline-block text-transparent bg-clip-text">Habiteer.</span></span>
